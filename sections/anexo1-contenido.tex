% Contenido del Anexo 1 - Documento de Casos de Uso

{\Large\bfseries Documento de Casos de Uso}

\vspace{1em}
\textbf{Versión [1.2]}

\vspace{2em}
% Mantener 'Historia de revisiones' en la misma página que el título (excepción).
\begingroup\let\clearpage\relax
\subsection{Historia de revisiones}
\endgroup
...
\input{sections/casos_de_uso/01-registrar_lote.tex}
\input{sections/casos_de_uso/02-analisis_pureza.tex}
\input{sections/casos_de_uso/03-analisis_pms.tex}
\input{sections/casos_de_uso/04-analisis_germinacion.tex}
\input{sections/casos_de_uso/05-analisis_tetrazolio.tex}
\input{sections/casos_de_uso/06-analisis_dosn.tex}
\input{sections/casos_de_uso/07-registrar_usuario.tex}
\input{sections/casos_de_uso/08-edicion_lotes.tex}
\input{sections/casos_de_uso/09-gestion_pureza.tex}
\input{sections/casos_de_uso/10-gestion_pms.tex}
\input{sections/casos_de_uso/11-gestion_analisis_germinacion.tex}
\input{sections/casos_de_uso/12-gestion_analisis_tetrazolio.tex}
\input{sections/casos_de_uso/13-gestion_analisis_dosn.tex}
\input{sections/casos_de_uso/14-finalizar-analisis.tex}
\input{sections/casos_de_uso/15-aprobar-analisis.tex}
\input{sections/casos_de_uso/16-marcar-analisis-para-repetir.tex}
\input{sections/casos_de_uso/17-gestion-de-usuario.tex}
\input{sections/casos_de_uso/18-actualizar-perfil-de-usuario.tex}
\input{sections/casos_de_uso/19-busquedas-y-filtros.tex}
\input{sections/casos_de_uso/20-exportacion-excel.tex}
\input{sections/casos_de_uso/21-notificaciones-basicas.tex}
\input{sections/casos_de_uso/22-autenticacion-2fa.tex}
\input{sections/casos_de_uso/23-bloqueo-usuario-pendiente-y-login.tex}
\input{sections/casos_de_uso/24-dashboard-basico.tex}
\input{sections/casos_de_uso/25-resportes-consolidados.tex}
\input{sections/casos_de_uso/26-importacion-excel.tex}
