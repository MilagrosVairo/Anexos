...
\begin{enumerate}[nosep]
    ...
    \begin{enumerate}[nosep]
        \item Para cada repetición, el usuario ingresa conteos según las fechas configuradas:
        \begin{itemize}[nosep]
            \item Primera fecha de conteo: número de semillas germinadas normalmente (obligatorio)
            \item Fechas adicionales: número de semillas germinadas normalmente (si fueron configuradas)
        \end{itemize}
